...
@section('content')
    ...
    <form method="post" action="{{ route('fastVisit.store') }}">
        ...
        <div class="mdui-tab mdui-tab-scrollable mdui-m-t-1" mdui-tab>
            ...
            <a href="#choose-domain" class="mdui-ripple">选择域名</a>
            <a href="#choose-forward" class="mdui-ripple">目标地址</a>
            <a href="#choose-ad" class="mdui-ripple">广告开关</a>
            <a href="#choose-name" class="mdui-ripple">其他设定</a>
        </div>

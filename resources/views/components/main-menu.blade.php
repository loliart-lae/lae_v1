    ...
    <div class="mdui-list" id="main-list">
        ...
        @else
            ...
            <a class="mdui-list-item mdui-ripple umami--click--shared-windows"
                ...
                <svg t="1634993381814" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2402" width="18" height="18" class="mdui-list-item-icon">

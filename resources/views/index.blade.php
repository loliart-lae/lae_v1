...
<div class="mdui-typo-headline-opacity">假期宝贵，准备好用Light App Engine与您的朋友们来一场盛宴了吗？</div> --}}
    ...
    <a href="#" onclick="window.open('https://lightart.top/documents/8')">阅览文档</a> --}}
        ...
        <h2 class="mdui-text-color-theme">2021.10.3 01:38 附：LAE 仍需要改进</h2>
        ...
        @auth
            <p>Light App Engine 是个人发起的项目，并由社区一同建造，为社区服务。我们不为赚大钱，安稳服务社区就好。</p>
            <p>Light App Engine 没有创始人，只有共建者。</p>
            <p>Light App Engine 由社区建造，但是主站代码并非开源，由创始人进行维护并听从搭建意见进行更新修补。</p>
